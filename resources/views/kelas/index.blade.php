                        ...
                        <div class="panel-body">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>{{$kelas->kode}}</td>
                                    <td>{{$kelas->nama}}</td>
                                    <td><a href="/kelas/{{$kelas->id}}/detail" class="btn btn-primary btn-sm">Detail</a>
                                    <a href="/kelas/{{$kelas->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="/kelas/{{$kelas->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin nih mau dihapus?')">Hapus</a></td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">INPUT KELAS BARU</h5>
